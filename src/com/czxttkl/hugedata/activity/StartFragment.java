...
import com.czxttkl.hugedata.service.TcpServerService;
...
/*		if (mSharedPreferences.getBoolean("tcpServerRunning", false)) {
			Message msg1 = new Message();
			msg1.what = SERVER_ESTABLISH_SUCCESSFUL;
			myButtonHandler.sendMessage(msg1);
		}*/
		...
		Log.i("Hugedata:StartFragment:OnResume:mTcpServerService",
				(mTcpServerService == null ? "null" : "not null"));
		doBindService();
